...
async def on_chat_start():
    ...
    try:
        ...
        logging.getLogger(__name__).exception("Error connecting to MCP")
        msg.content = "Failed to connect to MCP. Please try again later."
        await msg.update()
            ...
            for tool_call in assistant_message.tool_calls:
                ...
                async with cl.Step(name=name) as step:
                    ...
                    try:
                        ...
                        error_msg = "An error occurred while calling the tool."
