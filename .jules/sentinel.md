...
## 2026-07-13 - [Error Message Information Disclosure]
**Vulnerability:** The `on_chat_start` and `_handle_message` exception handlers in the Chainlit web chat interface were returning error strings with internal details (`str(e)`) to the user.
